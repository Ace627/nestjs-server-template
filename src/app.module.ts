...
import { AllExceptionsFilter, JwtAuthGuard, ResponseTransformInterceptor } from '@/common'
...
@Module({
  imports: [
    ...
    //  配置 Jwt Auth 权限认证
    JwtModule.registerAsync({ useFactory: (configService: ConfigService) => ({ secret: configService.get('JWT_SECRET') }), global: true, inject: [ConfigService] }),
  ...
  providers: [
    ...
    { provide: APP_GUARD, useClass: JwtAuthGuard }, // Jwt Token Auth 守卫
